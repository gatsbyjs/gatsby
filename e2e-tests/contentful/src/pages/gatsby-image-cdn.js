  ...
  query GatsbyImageCDNQuery {
    default: allContentfulAsset(
      ...
      nodes {
        ...
        constrained: gatsbyImage(width: 420)
        fullWidth: gatsbyImage(width: 200, layout: FIXED)
        fixed: gatsbyImage(width: 200, layout: FIXED)
        dominantColor: gatsbyImage(
          width: 200
          layout: FIXED
          placeholder: DOMINANT_COLOR
        )
        blurred: gatsbyImage(width: 200, layout: FIXED, placeholder: BLURRED)
        customImageFormats: gatsbyImage(formats: [AVIF, WEBP, AUTO])
      }
    }
