  ...
  <>
    ...
    >
      <div css={{ display: `flex`, flexDirection: `column` }}>
        ...
        >
          Please use the search bar to find plugins that will make your blazing
          fast site even more awesome. If you'd like to create your own plugin,
          see the <Link to="/docs/creating-plugins/">Plugin Authoring</Link>
          {` `}
          page in the docs! To learn more about Gatsby plugins, visit the {` `}
          {` `}
