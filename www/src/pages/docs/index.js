      ...
      <Layout location={this.props.location} itemList={itemListDocs}>
        <DocSearchContent>
          <Container>
            ...
            <ol>
              <li>
                <Link to="/tutorial/">Tutorial</Link>: Go to the tutorial for step-by-step instructions on how to install Gatsby and start a project. Great for people new to Gatsby and is written to be accessible to people without web
