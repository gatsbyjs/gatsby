  ...
  render() {
    return (
      <Container>
        ...
        <p>You can also use one of the premade <a href="https://github.com/gatsbyjs/gatsby#showcase">Gatsby starters</a> to save time, or learn about the possible usages of Gatsby in production. Starters are also great examples of how to implement different features!</p>
