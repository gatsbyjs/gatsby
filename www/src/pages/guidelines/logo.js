...
const GatsbyLogoContainered = ({ height, opacity, ...rest }) => (
  <Box
    {...rest}
    height={height}
    maxWidth="400px"
  ...
  <Layout pathname={location.pathname} pageTitle="Logo">
    ...
    <Section>
      <Columns>
        ...
        <ContentColumn>
          <GatsbyLogoContainered mb={4} />
          <p>
            Gatsby’s logo was created by Sacha Greif in late 2016, and is a true
            ...
            {` `}
            Check out <a href="#footnotes">the footnotes</a> to retrace the most
            important iteration steps.
          </p>
      ...
      <Columns>
        <CopyColumn sticky={false} id="dos">
          ...
          <List>
            ...
            <ListItem>
              Use the Gatsby logo or monogram to advertise that your product has
              built-in Gatsby integration
            </ListItem>
            <ListItem>
      ...
      <Columns>
        <CopyColumn sticky={false}>
          <p>
            ...
            Gatsby monogram/lettermark, and a wordmark. It is the preferred way
            to reference Gatsby, allowing newcomers to associate our brand name
            with the monogram. We encourage you to use it whenever possible.
          </p>
        </CopyColumn>
        <ContentColumn>
    ...
    <Section id="monogram">
      ...
      <Columns>
        <CopyColumn sticky={false}>
          ...
          <p>
            Furthermore the monogram may be used in cases where the association
            with Gatsby is evident, especially when space is an issue, e.g. like
            we currently do on store.gatsbyjs.org for mobile devices.
          </p>
        </CopyColumn>
        <ContentColumn>
    ...
    <Section id="guidance">
      ...
      <Columns>
        <CopyColumn>
          <p>
            Please help us maintain the integrity of the Gatsby logo and promote
            the consistency of the brand by not misusing it. Be responsible, not
            reckless.{` `}
            <span role="img" aria-label="thank you">
              🙏
            </span>
    ...
    <Section id="footnotes">
      ...
      <Columns>
        <CopyColumn>
          <p>
            Originally created by Sacha Greif in late 2016, the Gatsby logo is a
            true open source community effort. We compiled some of the steps
