...
1.  **Open the source code and start editing!**
    ...
    _Note: You'll also see a second link: _`http://localhost:8000/___graphql`_. This is a tool you can use to experiment with querying your data. Learn more about using this tool in the [Query for Data with GraphQL](https://www.gatsbyjs.com/docs/tutorial/part-4/).
