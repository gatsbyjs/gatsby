...
| `forceLinkClassNames`   | `['link']`              | Even when `linkImagesToOriginal` is `false`, images with one of the listed class names will be linked.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| `forceNoLinkClassNames` | `['no-link', 'nolink']` | Even when `linkImagesToOriginal` is `true`, images with one of the listed class names won't be linked.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
