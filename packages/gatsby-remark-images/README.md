...
| `srcSetAlwaysIncludeOriginal` | `true`  | By default gatsby includes the original size in the generated srcSet. Setting this to false will prevent the original image from being included if it is larger than the maximum desired breakpoint.                                                                                                                                                                                                                                                                                                                                                                                                                               |
