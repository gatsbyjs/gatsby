...
| `wrapFigureOnlyWithCaptions` | `true`  | Wrap the image with `<figure>` only when there is an image caption. By passing `false`, images without a caption will be wrapped in `<figure>` as well.                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
