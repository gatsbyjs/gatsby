          ...
          while (1) {
            switch ((_context.prev = _context.next)) {
              ...
              case 40:
                ...
                currentSyncData.entries = currentSyncData.entries.map(function(
                  e
                ) {
                  if (e) {
                ...
                currentSyncData.assets = currentSyncData.assets.map(function(
                  a
                ) {
                  if (a) {
                ...
                currentSyncData.deletedEntries = currentSyncData.deletedEntries.map(
                  function(e) {
                    if (e) {
                      return processAPIData.fixIds(e)
                    }
                ...
                currentSyncData.deletedAssets = currentSyncData.deletedAssets.map(
                  function(a) {
                    if (a) {
                      return processAPIData.fixIds(a)
                    }
