...
exports.initialSync = () => {
  return {
    currentSyncData: {
      entries: [
        ...
        },
        {
          ...
          fields: {
            ...
            localizedTextFieldRequired: {
              "en-US":
                "This field is required. Only english locale has a value.",
            },
      ...
      deletedAssets: [],
      nextSyncToken:
        "dDFSNcK6bMO7woHDuMK7A8O_KWQDPl1Kw7TDkX_CvcOnwrBpwqnDqR7Ci8OSHURwNsK4wrZaw4pzwqllPw1zA2AJdMKfw7pte8OSPwNBwoNqw6DCrMKiNUVgw58TWcKYw61pWAFew4fCjMKWwrbCl2DCjA",
    },
    tagItems: [],
    defaultLocale: "en-US",
    locales: [
