...
exports.initialSync = () => {
  return {
    currentSyncData: {
      ...
      deletedAssets: [],
      nextSyncToken:
        "FEnChMOBwr1Yw 4TCqsK2LcKpCH3CjsORIyLDrGbDtgozw6xreMKCwpjCtlxATw3CswoUY34WECLCh152KsOLQcKwH8Kfw4kOQcOlw6TCr8OmEcKiwrhBZ8KhwrLCrcOsA8KYAMOFwo1kBMOZwrHDgCbDllcXVA",
    },
    defaultLocale: "en-US",
    locales: [
      {
...
exports.createBlogPost = () => {
  return {
    currentSyncData: {
      ...
      deletedAssets: [],
      nextSyncToken:
        "FEnChMOBwr1Yw4TCqsK2LcKpCH3CjsORIyLDrGbDtgozw6xreMKCwpjCtlxATw0YQMOfwrtZBsOQw41ww7xhJj8Ew4TChcOow6ZPPVVZaMOfOlFEwp7CpcOxwpd_YcKBw5jCkznDgMO6w4lsw73CrcOmwpILwqTClg",
    },
    defaultLocale: "en-US",
    locales: [
      {
...
exports.updateBlogPost = () => {
  return {
    currentSyncData: {
      ...
      deletedAssets: [],
      nextSyncToken:
        "FEnChMOBwr1Yw4TCqsK2LcKpCH3CjsORIyLDrGbDtgozw6xreMKCwpjCtlxATw0OwpjDkMOywrZewqlOAMK_wp_DmcOzLRXDmlJ3wp5VextfJMKtw43CngvCrw7Cn07CgnNJw4XDscOsw5zCuXbDrMKnw7rCsTPCpxE",
    },
    defaultLocale: "en-US",
    locales: [
      {
...
exports.removeBlogPost = () => {
  return {
    currentSyncData: {
      ...
      deletedAssets: [],
      nextSyncToken:
        "FEnChMOBwr1Yw4TCqsK2LcKpCH3CjsORIyLDrGbDtgozw6xreMKCwpjCtlxATw13woJkDMK6fDpuN014SMKXw4MowpNDLcKVGQlXJiNSw53DlcKow4Fjw5HDqjthfQQrwo5MBlfDr3UfZjjCiMKi",
    },
    defaultLocale: "en-US",
    locales: [
      {
...
exports.removeAsset = () => {
  return {
    currentSyncData: {
      ...
      nextSyncToken:
        "FEnChMOBwr1Yw4TCqsK2LcKpCH3CjsORIyLDrGbDtgozw6xreMKCwpjCtlxATw0LNMOLwow1KMKwAW_Ci8OIwoPDgcK-Hn5Rw5XDvwXCsMK7wpPDk2jDtywiw6lyU8KEwprCojzDscOMwollMCbCicK_XTUEw7wZ",
    },
    defaultLocale: "en-US",
    locales: [
      {
