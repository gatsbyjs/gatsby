...
exports.initialSync = () => {
  return {
    currentSyncData: {
      ...
      deletedAssets: [],
      nextSyncToken:
        "dDFSNcK6bMO7woHDuMK7A8O_KWQDPkhAwpF6w7ovw49fQjrDj2gKH0xvwofCkMKDJcKgBMKCYcK9wr3DoVozwqEUC8OwWlVJBBt-F8K0BMKTP8OAwr8Xw6bCkcO2w6MpwqBmVX7CmsOwM3DDvWZvw5Q",
    },
    tagItems: [],
    defaultLocale: "en-US",
    locales: [
...
exports.editJustEntryWithBackLinks = () => {
  return {
    currentSyncData: {
      ...
      deletedAssets: [],
      nextSyncToken:
        "dDFSNcK6bMO7woHDuMK7A8O_KWQDPkhAwpF6w7ovw49fQjrDj2gKH0xvQMODwpLDkMK3Oj9Jw6jDkSoBMkc4woTCtMOFwoTDisKlT8O1w4AaKsOjasK1wrVSwrU3YsKVE8KPVMKyw4_CmVpwPsOew4IVwoA",
    },
    tagItems: [],
    defaultLocale: "en-US",
    locales: [
