...
exports.initialSync = () => {
  return {
    currentSyncData: {
      ...
      deletedAssets: [],
      nextSyncToken:
        "dDFSNcK6bMO7woHDuMK7A8O_KWQDPl1Kw7TDkX_CvcOnwrBpwqnDqR7Ci8OSHURla8OTIQYqZD_Cl2F6ZcK5TcKMwp8hw7fDojYtLTkUwofCisKjwrvDu1AxPsOMPMK9KyPDoiXDlnrDuWfCqXJzWsO-",
    },
    tagItems: [],
    defaultLocale: "en-US",
    locales: [
