...
const createMockCache = () => {
  ...
  return {
    get: jest.fn((key) =>
      Promise.resolve(_.cloneDeep(actualCacheMap.get(key))),
    ),
...
const exampleImage = {
  ...
  file: {
    ...
    fileName:
      "347966-contentful-logo-wordmark-dark (1)-4cd185-original-1582664935 (1).png",
...
describe("gatsby-plugin-image", () => {
  ...
  describe("generateImageSource", () => {
    it("default", () => {
      const resp = generateImageSource(
        "//test.png",
        420,
        210,
        "webp",
