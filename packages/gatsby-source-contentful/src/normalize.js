...
exports.createContentTypeNodes = ({
  ...
  locales.forEach(locale => {
    ...
    const entryNodes = entries.map(entryItem => {
      ...
      const contentDigest = createContentDigest(entryNode)
    ...
    // Get content digest of node.
    const contentDigest = createContentDigest(contentTypeNode)
...
exports.createAssetNodes = ({
  ...
  locales.forEach(locale => {
    ...
    // Get content digest of node.
    const contentDigest = createContentDigest(assetNode)
