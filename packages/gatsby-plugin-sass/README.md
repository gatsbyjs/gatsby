...
Using [resolve-url-loader](https://github.com/bholloway/resolve-url-loader) may provides a workaround, if you want to use relative url just install the plugin and then add it to your sass plugin options configuration.
