...
For more information on how to customize the Babel configuration of your Gatsby site, check out [our documentation](https://gatsbyjs.org/docs/babel).
...
Use this option to configure [custom target browsers](https://gatsbyjs.org/docs/babel).
