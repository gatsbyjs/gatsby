  ...
  return {
    ...
    video: {
      ...
      args: {
        ...
        h264MaxRate: { type: GraphQLString, defaultValue: `2M` },
        h264BufSize: { type: GraphQLString, defaultValue: `4M` },
        h264Preset: { type: GraphQLString, defaultValue: `veryslow` },
        h265Crf: { type: GraphQLInt, defaultValue: null },
        h265MaxRate: { type: GraphQLInt, defaultValue: 1000 },
        h265BufSize: { type: GraphQLInt, defaultValue: 2000 },
