  ...
  return {
    ...
    video: {
      ...
      args: {
        ...
        h264Crf: { type: GraphQLInt, defaultValue: null },
        h264MaxRate: { type: GraphQLString, defaultValue: `1.5M` },
        h264BufSize: { type: GraphQLString, defaultValue: `3M` },
        h264Preset: { type: GraphQLString, defaultValue: `veryslow` },
        h265Crf: { type: GraphQLInt, defaultValue: null },
        h265MaxRate: { type: GraphQLInt, defaultValue: 500 },
        h265BufSize: { type: GraphQLInt, defaultValue: 1000 },
