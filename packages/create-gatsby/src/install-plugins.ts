...
import type { PluginConfigMap } from "."
import { requireResolve } from "./utils/require-utils"

function resolveGatsbyPath(rootPath: string): string | never {
  try {
...
async function addPluginsToProject(
  installPluginCommand: string,
  plugins: Array<string>,
  pluginOptions: PluginConfigMap | undefined = {},
  rootPath: string,
