...
Check out an example of [how you could implement](https://gatsbyjs.org/docs/adding-an-rss-feed) to your own site, with a custom `serialize` function, and additional functionality.
