...
const LinkIndicatorButton: FC = () => {
  ...
  useEffect(() => {
    if (currentBuildStatus === BuildStatus.BUILDING || currentBuildStatus === BuildStatus.UP_TO_DATE) {
  ...
  return <IndicatorButton onMouseEnter={!buttonProps.disabled ? onMouseEnter : undefined} {...buttonProps} />;
};
