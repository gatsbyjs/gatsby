...
export const handlers = [
  rest.get(`https://test.com/success`, async (req, res, ctx) =>
    res(
      ctx.json({
        currentBuild: { id: `123`, buildStatus: `SUCCESS`, createdAt: `2021-05-11T14:45:10.263Z` },
  ...
  rest.get(`https://test.com/uptodate`, async (req, res, ctx) =>
    res(
      ctx.json({
        currentBuild: { id: null, buildStatus: `SUCCESS`, createdAt: `2021-05-11T14:45:10.263Z` },
  ...
  rest.get(`https://test.com/fetching`, async (req, res, ctx) =>
    res(
      ctx.json({ currentBuild: {}, latestBuild: {}, siteInfo: {} })
    )
  ),
]
