...
describe("extend/add prism language", () => {
  ...
  it("should extend pre-loaded language", () => {
    const request = {
      ...
      definition: {
        flexc_keyword:
          "(__cm|__circ|_lpp_indirect|__accum|__size_t|__ptrdiff_t|__wchar_t|__fixed|__abscall|__extcall|__stkcall|__sat|__i64_t|__i32_t|__i16_t|__r32_t|__r16_t|__u64_t|__u32_t|__u16_t|__a40_t|__a24_t)",
      },
    };
