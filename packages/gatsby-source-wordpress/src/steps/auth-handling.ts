...
export const hideAuthPluginOptions: Step = async function hideAuthPluginOptions(
...
export const restoreAuthPluginOptions: Step =
  async function restoreAuthPluginOptions(
    _helpers: GatsbyNodeApiHelpers,
    pluginOptions: IPluginOptions,
  ): Promise<void> {
