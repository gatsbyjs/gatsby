...
export const logPostBuildWarnings: Step =
  async function logPostBuildWarnings(): Promise<void> {
    const {
    ...
    const helpUrl =
      "https://github.com/gatsbyjs/gatsby/blob/master/packages/gatsby-source-wordpress/docs/debugging-and-troubleshooting.md#media-file-download-skipped";
