...
| `skipSvg`              | `false` | Skip SVGs from being optimized. It usually doesn't make sense to optimize SVGs as they are vector-based. Setting this to `true` will leave the original `<img />` tag as is.                                                                                                    |
