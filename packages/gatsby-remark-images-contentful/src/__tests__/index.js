...
test("it throws specific error if the image is not found", async () => {
  ...
  const imagePath =
    "https://images.ctfassets.net/rocybtov1ozk/wtrHxeu3zEoEce2MokCSi/73dce36715f16e27cf5ff0d2d97d7dff/doesnotexist.jpg";
  const content = `
![image](${imagePath})
  `.trim();
...
test("it shows an useful error message when the file is not a valid image", async () => {
  ...
  const imagePath =
    "//images.ctfassets.net/k8iqpp6u0ior/752jwCIe9dwtfi9mLbp9m2/bc588ee25cf8299bc33a56ca32f8677b/Gatsby-Logos.zip";
