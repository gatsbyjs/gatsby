...
Global site tag (gtag.js) is meant to combine multiple Google tagging systems and can replace older ones such as [analytics.js](https://developers.google.com/analytics/devguides/collection/analyticsjs) ([gatsby-plugin-google-analytics](https://gatsbyjs.org/packages/gatsby-plugin-google-analytics)).
...
export default () => (
  <div>
    <OutboundLink href="https://gatsbyjs.org/packages/gatsby-plugin-google-gtag/">
