...
Where do you want to place the GA script? By putting `head` to `true`, it will be placed in the "header" of your website. By setting it to `false`, it will be placed in the "body". The default value resolves to `false`.
