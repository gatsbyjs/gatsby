...
Here you can define where to place the tracking script. With `head:true` it will be placed in the header, and with `head:false`, it will be placed in the body. Defaults to `false`.
