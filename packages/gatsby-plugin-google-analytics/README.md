...
export default () => {
  <div>
    <OutboundLink
      href="https://gatsbyjs.org/packages/gatsby-plugin-google-analytics"
    >
...
If your site uses any custom transitions on route update (e.g. [`gatsby-plugin-transition-link`](https://gatsbyjs.org/blog/2018-12-04-per-link-gatsby-page-transitions-with-transitionlink)), then you can delay processing the page view event until the new page is mounted.
