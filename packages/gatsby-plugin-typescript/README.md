...
When [creating pages programmatically](https://www.gatsbyjs.org/docs/programmatically-create-pages-from-data/#creating-pages), you can pass the `.tsx` filename directly as the `component` for [`createPage`](https://www.gatsbyjs.org/docs/actions/#createPage).
