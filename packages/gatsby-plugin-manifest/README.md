...
manifest is a JSON file that lets users (on Chrome, Edge, Firefix, Safari Mobile, and Opera —
[support in and Safari Desktop is under development](http://caniuse.com/#feat=web-app-manifest))
