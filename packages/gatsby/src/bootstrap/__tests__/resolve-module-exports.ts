...
describe("Resolve module exports", () => {
  const MOCK_FILE_INFO = {
    ...
    "/multiple/export":
      "exports.bar = () => ''; exports.baz = {}; exports.foo = '';",
    ...
    "/export/named/multiple":
      "const foo = ''; const bar = ''; const baz = ''; export { foo, bar, baz };",
  ...
  it("Resolves exports from a larger file", async () => {
    const result = await resolveModuleExports("/realistic/export", {
      resolver,
    });
