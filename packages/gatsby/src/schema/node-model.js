...
/**
 * See redux/run-sift.js and keep typedef in sync
 *
 * @typedef {Map<
    string,
    {
...
class LocalNodeModel {
   ...
   */
  replaceTypeKeyValueCache(filterCache = new Map()) {
    this._filterCache = filterCache // See redux/nodes.js for usage
  }
