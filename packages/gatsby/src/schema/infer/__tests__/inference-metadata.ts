...
function getExampleValueConflicts(args: {
  nodes: Array<IGatsbyNode>;
  typeName?: string | undefined;
  ignoreFields?: Array<string> | undefined;
  typeConflictReporter?: TypeConflictReporter | undefined;
}): Array<TypeConflictEntry> {
...
describe("Type conflicts", () => {
  ...
  it("reports on mixed numbers and numeric strings in arrays", () => {
    const nodes: Array<IGatsbyNode> = [
      { id: "1", parent: null, children: [], internal: {}, numeric: [1, 2] },
      { id: "2", parent: null, children: [], internal: {}, numeric: [4, "5"] },
    ];
