            ...
            Frontmatter: {
              authors: {
                resolve(source, args, context, info) {
                  console.log(
                    `####\n####\n#### Resolving Frontmatter.authors now\n####\n####`
                  )
                  ...
                  if (
                    ...
                    console.log(
                      `####\n####\n#### Early finish resolving Frontmatter.authors, returning ` +
                        r.length +
                        ` nodes\n####\n####`
                    )
                    return source.authors
                  }
                  let r = context.nodeModel
                    .getAllNodes({ type: `Author` })
                    .filter(author => source.authors.includes(author.email))

                  console.log(
                    `####\n####\n#### Finished resolving Frontmatter.authors, returning ` +
                      r.length +
                      ` nodes\n####\n####`
                  )
