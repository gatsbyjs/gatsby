...
class ContextualNodeModel {
  ...
  getNodeById(args, pageDependencies?: PageDependencies | undefined): any {
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  findOne(args, pageDependencies?: PageDependencies | undefined): any {
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  findAll(args, pageDependencies?: PageDependencies | undefined): any {
  ...
  trackPageDependencies(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    result: any,
    pageDependencies?: Record<string, string> | undefined,
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
  ): any {
