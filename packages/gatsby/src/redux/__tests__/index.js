...
const pageTemplatePath =
  "/Users/username/dev/site/src/templates/my-sweet-new-page.js";
          ...
          new Array(numberOfPages).fill(undefined).map((_, index) => {
            return {
              ...
              context: {
                objectType: "page",
                possiblyHugeField:
                  "let's pretend this field is huge (we will simulate that by mocking some things used to asses size of object)",
              },
            };
          }),
        );
