 ...
 * @param {string} manifest.updatedAtUTC (optional) The time in which the node was last updated. If this parameter is not included, we will create a manifest for every node that gets called. We default to creating node manifests for content updated in the last 30 days. To change that, set a NODE_MANIFEST_MAX_DAYS_OLD environment variable.
 * @example
