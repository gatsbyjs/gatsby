...
export type IFilterCache = {
  ...
  meta: {
    ...
    nodesUnordered?: Array<IGatsbyNodePartial> | undefined;
    // Flat list of all nodes by requested types, ordered by counter (cached for empty filters)
    orderedByCounter?: Array<IGatsbyNodePartial> | undefined;
    // Ordered list of all values (by `<`) found by this filter. No null / undefs
    valuesAsc?: Array<FilterValue> | undefined;
    // Flat list of nodes, ordered by valueAsc
    nodesByValueAsc?: Array<IGatsbyNodePartial> | undefined;
    // Ranges of nodes per value, maps to the nodesByValueAsc array
    valueRangesAsc?: Map<FilterValue, [number, number]> | undefined;
    // Ordered list of all values (by `>`) found by this filter. No null / undefs
    valuesDesc?: Array<FilterValue> | undefined;
    // Flat list of nodes, ordered by valueDesc
    nodesByValueDesc?: Array<IGatsbyNodePartial> | undefined;
    // Ranges of nodes per value, maps to the nodesByValueDesc array
    valueRangesDesc?: Map<FilterValue, [number, number]> | undefined;
  };
};
