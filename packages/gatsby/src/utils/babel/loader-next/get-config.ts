...
function getFreshConfig(
  ...
  let options = {
    ...
    sourceMaps:
      loaderOptions.sourceMaps === loaderOptions.sourceMaps,
    ...
    presets: (() => {
      // If presets is defined the user will have babel-preset-gatsby in their babelrc
      ...
      // If no custom config is provided the default is to use babel-preset-gatsby
      return ['babel-preset-gatsby']
    })(),
