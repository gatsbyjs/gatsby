...
module.exports = async ({
   ...
   */
  {
    const css = ({ browsers, ...options } = {}) => {
      ...
      if (!isSSR) {
        // when running a modern build we do not extract css. We still need the classnames
        // generated by css-loader.
        if (options.modern) {
          use.unshift(loaders.null())
        } else {
          use.unshift(loaders.miniCssExtract({ hmr: !options.modules }))
        }
      }
