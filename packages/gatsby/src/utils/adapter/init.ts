...
import { version as gatsbyVersionFromPackageJson } from "../../../package.json" with { type: "json" };
...
async function createAdaptersCacheDir(): Promise<void> {
  ...
  await outputJson(packageJsonPath, {
    ...
    description:
      "This directory contains adapters that have been automatically installed by Gatsby.",
    version: "1.0.0",
    private: true,
    author: "Gatsby",
    license: "MIT",
