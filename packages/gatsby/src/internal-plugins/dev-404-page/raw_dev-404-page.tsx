...
type Props = {
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  location: any;
  custom404: null | JSX.Element;
};

type State = {
  hasMounted: boolean;
  showCustom404: boolean;
  initPagePaths: Array<string>;
  pagePathSearchTerms: string;
  pagePaths: Array<string>;
};

class Dev404Page extends React.Component<Props, State> {
  static propTypes = {
  ...
  constructor(props: Props) {
    ...
    this.state = {
      hasMounted: false,
      showCustom404: Boolean(process.env.GATSBY_DISABLE_CUSTOM_404) ?? false,
      initPagePaths: pagePaths,
      pagePathSearchTerms:
        typeof initialPagePathSearchTerms === "string"
  ...
  handleSearchTermChange(event): void {
  ...
  handlePagePathSearch(event: FormEvent<HTMLFormElement>): void {
  ...
  render(): JSX.Element | null {
    ...
    return this.state.showCustom404 ? (
      ...
      <div>
        ...
        <p>
          There's not a page or function yet at <code>{pathname}</code>
        </p>
        {this.props.custom404 ? (
          <p>
        ...
        {newFilePath && (
          <div>
            ...
            <p>
              ...
              directory at "<code>{newFilePath}</code>" and then refresh to show
              the new page component you created.
            </p>
            <pre
              style={{
        ...
        {newAPIPath && (
          <div>
            ...
            <p>
              ...
              at "<code>{newAPIPath}</code>" and refresh to execute the new API
