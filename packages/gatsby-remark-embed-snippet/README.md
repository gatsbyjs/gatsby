...
**Note**: This plugin depends on [gatsby-remark-prismjs](https://gatsbyjs.org/packages/gatsby-remark-prismjs) and [gatsby-transformer-remark](https://gatsbyjs.org/packages/gatsby-transformer-remark) plugins
...
> For more information, see [gatsby-remark-prismjs](https://gatsbyjs.org/packages/gatsby-remark-prismjs).
