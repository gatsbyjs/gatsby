...
Unlike in [gatsby-remark-component](https://gatsbyjs.org/packages/gatsby-remark-component) where you can only use HTML within the custom component tag, custom blocks allow you to use markdown within the block.
