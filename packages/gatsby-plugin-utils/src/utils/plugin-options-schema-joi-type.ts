...
type ValidationError = Error & {
   ...
   */
  annotate: (stripColors?: boolean | undefined) => string;
...
type CustomHelpers<V = any> = {
  ...
  original: V;
  warn: (code: string, local?: Context | undefined) => void;
  error: (code: string, local?: Context | undefined) => ErrorReport;
  message: (
    messages: LanguageMessages,
...
interface SchemaInternals {
  ...
  $_modify: (options?: ModifyOptions | undefined) => Schema;
  ...
  $_mutateRegister: (
    schema: Schema,
    options?: MutateRegisterOptions | undefined,
  ) => void;
  ...
  $_setFlag: (
    flag: string,
    value: any,
    options?: SetFlagOptions | undefined,
  ) => void;
...
interface AnySchema extends SchemaInternals {
   ...
   */
  cache: (cache?: Cache | undefined) => this;
   ...
   */
  example: (value: any, options?: { override: boolean } | undefined) => this;
...
interface StringSchema extends AnySchema {
   ...
   */
  base64: (options?: Base64Options | undefined) => this;
  ...
  pattern: (
    pattern: RegExp,
    options?: string | StringRegexOptions | undefined,
  ) => this;
...
type Extension = {
  ...
  manifest?:
    | {
        build:
          | ((obj: ExtensionBoundSchema, desc: Record<string, any>) => any)
          | undefined;
      }
    | undefined;
  messages?: LanguageMessages | string | undefined;
  modifiers?:
    | Record<string, (rule: any, enabled?: boolean | undefined) => any>
    | undefined;
