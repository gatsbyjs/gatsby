...
1.  You have a large or complex V1 site and [refactoring to the new layout component](https://gatsbyjs.org/docs/migrating-from-v1-to-v2/#remove-or-refactor-layout-components) is not feasible
