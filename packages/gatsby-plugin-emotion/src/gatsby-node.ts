import type { GatsbyNode, PluginOptionsSchemaArgs } from 'gatsby'

export const onCreateBabelConfig: GatsbyNode['onCreateBabelConfig'] = ({ actions, store }, pluginOptions) => {
...
export const pluginOptionsSchema: GatsbyNode['pluginOptionsSchema'] = ({ Joi }: PluginOptionsSchemaArgs) => {
  return Joi.object({
