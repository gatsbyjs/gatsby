...
exports.pluginOptionsSchema = ({ Joi }) =>
  Joi.object({
    ...
    cssPropOptimization: Joi.boolean()
      .default(true)
      .description(
        `This option assumes that you are using something to make @emotion/reacts’s jsx function work for all jsx. If you are not doing so and you do not want such optimizations to occur, disable this option.`
      ),
  })
