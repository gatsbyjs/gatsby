...
describe("getCollectionRouteParams", () => {
  ...
  it("gets multiple params out of url in same part", () => {
    const filePath =
      "/{Product.name}-{Product.id}_{Product.desc}.{Product.number}.js";
  ...
  it("gets multiple params out of url with prefixes", () => {
    const filePath =
      "/products/prefix-{Product.id}/another-prefix_{Product.name}/product.js";
  ...
  it("gets multiple params out of url with postfixes", () => {
    const filePath =
      "/products/{Product.id}-postfix/{Product.name}_another-postfix/product.js";
