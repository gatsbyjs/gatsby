...
export type ICreateAPageFromNodeArgs = {
  node: Record<string, Record<string, unknown>>;
  absolutePath: string;
};
export type IStatePerInstance = {
   ...
   */
  getPathFromAResolvedNode?:
    | ((arg: ICreateAPageFromNodeArgs) => Promise<string>)
    | undefined;
  /**
   ...
   */
  deletePagesCreateFromNode?: ((id: string) => void) | undefined;
  /**
