...
import slugify, {
  type Options as ISlugifyOptions,
...
export async function derivePath(
  ...
  getFieldValue?: // eslint-disable-next-line @typescript-eslint/no-explicit-any
  ((node: Record<string, any>, fieldPath: string) => any) | undefined,
