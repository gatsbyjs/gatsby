...
describe(`gatsby-plugin-sharp`, function () {
  ...
  describe(`responsiveSizes`, function () {
    it(`includes responsive image properties, e.g. sizes, srcset, etc.`, (0, _asyncToGenerator3.default)(regeneratorRuntime.mark(function _callee() {
      var result;
    ...
    it(`adds pathPrefix if defined`, (0, _asyncToGenerator3.default)(regeneratorRuntime.mark(function _callee2() {
  ...
  describe(`base64`, function () {
    it(`converts image to base64`, (0, _asyncToGenerator3.default)(regeneratorRuntime.mark(function _callee3() {
      var result;
