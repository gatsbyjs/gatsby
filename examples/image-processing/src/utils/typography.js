...
theme.overrideThemeStyles = ({ rhythm, scale }, options) => {
  return {
    ...
    // borrowed from https://github.com/confusion/after-dark/
    // @see https://github.com/confusion/after-dark/blob/8fdbe2f480ac40315cf0e01cece785d2b5c4b0c3/layouts/partials/critical-theme.css#L36-L39
    "a[href*='//']:after": {
