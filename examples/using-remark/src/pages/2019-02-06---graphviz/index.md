...
By adding [gatsby-remark-graphviz](https://gatsbyjs.org/packages/gatsby-remark-graphviz) to your Gatsby site, you can create graphs powered by [Viz.js](https://github.com/mdaines/viz.js) by adding `dot` code blocks in your Markdown files:
...
This will make graphs work as expected most of the time - small graphs will remain small and big ones will shrink to fit the parent's box. Graphs can get really big ([from Gatsby the docs](https://gatsbyjs.org/docs/behind-the-scenes)):
