...
exports.createPages = ({ actions, graphql }) => {
  ...
  // https://gatsbyjs.com/docs/bound-action-creators/
  ...
  // https://gatsbyjs.com/docs/building-with-components/
  // and handling trailing slashes:
  // Docs > Creating and modifying pages > Removing trailing slashes
  // https://gatsbyjs.com/docs/creating-and-modifying-pages/#removing-trailing-slashes
  createRedirect({
    fromPath: `/page2/`,
    isPermanent: true,
    redirectInBrowser: true,
