...
exports.createPages = ({ actions, graphql }) => {
  ...
  // https://gatsbyjs.org/docs/bound-action-creators/
  ...
  // https://gatsbyjs.org/docs/building-with-components/
  // and handling trailing slashes:
  // Docs > Creating and modifying pages > Removing trailing slashes
  // https://gatsbyjs.org/docs/creating-and-modifying-pages/#removing-trailing-slashes
  createRedirect({
    fromPath: `/page2/`,
    isPermanent: true,
    redirectInBrowser: true,
