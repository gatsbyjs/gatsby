  ...
  <Layout>
    <div>
      ...
      <p>
        ...
        &nbsp;
        <a href="https://gatsbyjs.com/docs/bound-action-creators/">
      ...
      <p>
        ...
        {` `}
        <a href="https://gatsbyjs.com/docs/building-with-components/">
          page components
        </a>
        &nbsp;at either version by default, but we need to explicitly redirect
        both versions independently (More on
        {` `}
        <a href="https://gatsbyjs.com/docs/creating-and-modifying-pages/#removing-trailing-slashes">
