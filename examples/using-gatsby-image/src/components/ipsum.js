...
const Ipsum = () => (
  <div>
    <h2>Reality is merely an a priori adjunct of non-naturalistic ethics</h2>
    <p>
      <a href="http://example.com/">Hegel is arguing</a> that the reality is
      merely an a priori adjunct of non-naturalistic ethics, Kant via the
