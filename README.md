...
Also, [see here](https://www.gatsbyjs.com/docs/reference/release-notes/gatsby-version-support/) to understand the version support plans for each version of Gatsby.
