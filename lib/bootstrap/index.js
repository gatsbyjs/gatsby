...
import { routesDB, site } from '../utils/globals'
...
module.exports = async (program, cb) => {
  ...
  if (config.default) {
    siteObj.config = config.default
  } else {
    siteObj.config = config
  }
  site(siteObj)
  ...
  // TODO standardize passing script names to html.js and add a component
  // for it to /isomorphic. Create util module with helper functions for creating
  // bundle names for various things.
