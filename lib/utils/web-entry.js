...
import { onRouteChange, onRouteUpdate, modifyRoutes, customShouldUpdateScroll } from 'gatsby-browser'
...
function shouldUpdateScroll (prevRouterProps, nextRouterProps) {
  if (customShouldUpdateScroll) {
    return customShouldUpdateScroll(prevRouterProps, nextRouterProps)
  }
  if (prevRouterProps) {
