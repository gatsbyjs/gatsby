...
![](/src/uploads/Screen Shot 2019-02-04 at 10.23.12 AM.png)
...
They’ve been in business for four years, and for most of that time they had a Wordpress site. But although this served them well early on, eventually it grew large and unwieldy, and that in turn impacted page load times and stability. There were a lot of plug-ins, and even making simple changes like editing or creating a single page, would often break the site and necessitate extensive troubleshooting. 
...
The day they launched, the Hapticmedia team was immediately impressed by the fast page load times of the new site and the seamless page transitions due to Gatsby’s pre-fetching (which comes in Gatsby out-of-the-box). As the team scrolled down the page, they watched in Chrome Dev Tools as the subsequent pages loaded in the background. This pre-loading of pages meant there were no hiccups in page transitions so moving between pages was almost instantaneous. 
