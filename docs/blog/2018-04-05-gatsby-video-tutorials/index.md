...
Ready to dive in? [All four parts of Khaled’s video series are now available on YouTube](https://youtu.be/Ek4o40w1tH4?list=PL8KiuH6vpACV-F7jXribe4YveGBhBeG9A). You can also [find the source code on GitHub](https://github.com/Khaledgarbaya/gatsby-contentful-site).
