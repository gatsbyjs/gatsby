...
- GraphiQL Explorer is now available in the WPGraphiQL plugin for WordPress. Thanks to [Henrik](https://github.com/henrikwirth) for [adding this feature](https://github.com/wp-graphql/wp-graphiql/pull/16)
...
I'm a big fan of the team at Narative and think Novela shows off some of the best parts of Gatsby themes.
