...
[Nat Alison](https://twitter.com/tesseralis) who helped translating the React documentation is helping us setting up the the Gatsby documentation for translations. She's documented a few possible approaches that have worked in her experience in the [RFC for Gatsby Docs Localization](https://github.com/gatsbyjs/rfcs/pull/42).
