...
![Install the Gatsby CLI tool](images/code1.png)
...
![Create the new gatsby project](images/code2.png)
...
![Default package.json file](images/code3.png)
...
![Running the gatsby develop command](images/code4.png)
...
![Adding packages for WordPress](images/code5.png)
...
![Finished gatsby-config.js file](images/code6.png)
...
![Creating templates directory with BlogPost template](images/code7.png)
...
![Starter template for BlogPost.js](images/code8.png)
...
![Gatsby-node.js file with blog posts being created](images/code9.png)
...
![Our finished Blog Post Template](images/code10.png)
