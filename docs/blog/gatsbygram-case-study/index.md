...
Gatsby is a JavaScript web framework that let's you build fast, dynamic, mobile-ready websites _without_ an advanced degree in JavaScript wizardry.
...
Gatsby loads first a static server-rendered HTML page and then the JavasScript to convert the site into a web application. Which means that clicking around the site doesn't require a page reload. Gatsby _pre-caches_ code and data needed for other pages so that clicking on a link loads the next page instantly.
