...
In the [follow up post](https://jiahao.codes/blog/integrating-and-building-all-the-things/), I will showcase the amazing integrations and features I have set up, to be on the cutting edge of web development!

Check out the source code on [GitHub](https://github.com/jiahaog/jiahao.codes)!
