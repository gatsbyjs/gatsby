...
**Answer:** Yup (with a source plugin!). If it's a GraphQL API you can even use [/packages/gatsby-source-graphql/](/packages/gatsby-source-graphql/ "/packages/gatsby-source-graphql/") to invoke that API at _build time_
...
**Answer:** Check out [/docs/environment-variables/](/docs/environment-variables/ "/docs/environment-variables/") for env variables.
...
**Answer:** Gatsby splits code automatically by route so code only used on the admin panel will only be loaded there. Check out this page for details about how to build the admin section [/docs/building-apps-with-gatsby/](/docs/building-apps-with-gatsby/ "/docs/building-apps-with-gatsby/")

### GraphQL / Data Layer

**Question:** How does Gatsby work with GraphQL APIs? Create static pages with the content or only when it renders the page?
**Answer:** With third party graphql APIs — [/blog/2018-09-25-announcing-graphql-stitching-support/](/blog/2018-09-25-announcing-graphql-stitching-support/ "/blog/2018-09-25-announcing-graphql-stitching-support/")

**Question:** Is it necessary to use GraphQL for work with Gatsby?
**Answer:** Nope! [/docs/using-gatsby-without-graphql/](/docs/using-gatsby-without-graphql/ "GraphQL")
...
**Answer:** You can start with [/docs/using-gatsby-without-graphql/](/docs/using-gatsby-without-graphql/ "/docs/using-gatsby-without-graphql/") and go from there!
...
**Answer:** There's a few ways you can handle it. See this docs page which talks about the various options [/docs/adding-images-fonts-files/](/docs/adding-images-fonts-files/ "/docs/adding-images-fonts-files/")

**Question:** The question asked about search—how would you implement a site search in Gatsby?
**Answer:** One of the best things about Gatsby is that it's pretty agnostic on tech stack(s). So you're free to use what you want. I've used Algolia in the past and loved it, but you're free to implement this however you'd like! [/docs/adding-search/](/docs/adding-search/ "Gatsby Docs")
...
**Answer:** Yes, process.env is recommended for secret management. [/docs/environment-variables/](/docs/environment-variables/ "/docs/environment-variables/"), Generally you'd add these to gatsby-config.js — so would be used for the build but wouldn't be sent to users, so the keys wouldn't leak.
...
**Answer:** When you use Gatsby + Ghost you will construct UI in Gatsby rather than Ghost -- [/blog/2019-01-14-modern-publications-with-gatsby-ghost/](/blog/2019-01-14-modern-publications-with-gatsby-ghost/ "/blog/2019-01-14-modern-publications-with-gatsby-ghost/")
...
**Answer:** We have some tooling planned for this :) Stay tuned! [/blog/2018-07-17-announcing-gatsby-preview/](/blog/2018-07-17-announcing-gatsby-preview/ "/blog/2018-07-17-announcing-gatsby-preview/")
...
**Answer:** There are blog posts people have written about their experience on our blog at [/blog/tags/wordpress](/blog/tags/wordpress "Gatsby Blog")
...
**Answer:** You can use a DB as your backend -- [/docs/sourcing-from-databases/](/docs/sourcing-from-databases/ "Gatsby Docs"). Posting to a database can be done with AJAX requests.

**Question:** What are your thoughts on sanity.io?
**Answer:** Seems great :) Check out this blog post for more info -> [/blog/2019-01-25-blazing-fast-development-with-gatsby-and-sanity-io/](/blog/2019-01-25-blazing-fast-development-with-gatsby-and-sanity-io/ "/blog/2019-01-25-blazing-fast-development-with-gatsby-and-sanity-io/")
...
**Answer:** We're building a service for Preview that'll instantly update a staging version of the site and that can handle as many content updaters as you throw at it [/blog/2018-07-17-announcing-gatsby-preview/#reach-skip-nav](/blog/2018-07-17-announcing-gatsby-preview/#reach-skip-nav "/blog/2018-07-17-announcing-gatsby-preview/#reach-skip-nav")
...
**Answer:** Lots of CMS-s! Here's a list: [/docs/headless-cms/](/docs/headless-cms/ "Gatsby Docs")
...
**Answer:** gatsby-source-drupal only supports Drupal 8 at the moment, I believe. [/packages/gatsby-source-drupal/?=drupal](/packages/gatsby-source-drupal/?=drupal "Gatsby and Drupal")
...
**Answer:** Check out [/docs/building-a-site-with-authentication/](/docs/building-a-site-with-authentication/ "/docs/building-a-site-with-authentication/") and [/docs/building-apps-with-gatsby/](/docs/building-apps-with-gatsby/ "/docs/building-apps-with-gatsby/")
...
**Answer:** Yep! Check out [/docs/seo/](/docs/seo/ "/docs/seo/")
...
**Answer:** Check out [/docs/building-a-site-with-authentication/](/docs/building-a-site-with-authentication/ "Gatsby docs")
...
**Answer:** Here's a good overview, although doesn't tackle Next specifically: [/features/](/features/ "Gatsby features")
...
**Answer:** Definitely not! Here are some blogs built with Gatsby: [/showcase/?filters%5B0%5D=Blog](/showcase/?filters%5B0%5D=Blog "Gatsby Showcase"). One notable one is Dan Abramov — [https://overreacted.io/](https://overreacted.io/ "https://overreacted.io/")
...
**Answer:** Yep! Here are some sites using Gatsby in production: [/showcase/ ](/showcase/ "Gatsby Showcase")(includes the Flamingo e-commerce site).
...
**Answer:** You don't need to! Gatsby is a great playground for learning React. Check out this post: [/blog/2018-12-19-gatsby-scales-with-expertise-and-scope/](/blog/2018-12-19-gatsby-scales-with-expertise-and-scope/ "/blog/2018-12-19-gatsby-scales-with-expertise-and-scope/")
...
**Answer:** Unless you're on v1, you won't need a migration. If you are on v1 and want to move to v2: [/docs/migrating-from-v1-to-v2/](/docs/migrating-from-v1-to-v2/ "/docs/migrating-from-v1-to-v2/").
...
**Answer:** Look at [/blog/2018-11-11-introducing-gatsby-themes/](/blog/2018-11-11-introducing-gatsby-themes/ "/blog/2018-11-11-introducing-gatsby-themes/") and [https://www.gatsbyjs.com/gatsby-days-themes-chris/](https://www.gatsbyjs.com/gatsby-days-themes-chris/ "https://www.gatsbyjs.com/gatsby-days-themes-chris/") and stay tuned for more posts in next week!
...
**Answer:** We do have Discord, and highly recommend it! Check out our Community page -> [/docs/community/](/docs/community/ "Gatsby Community")
