...
![Amplify Console](amplify1.png)

Next, we'll choose GitHub as our repository & click __Next__.

![Choosing repo](amplify2.png)

Then connect the mater branch of the new repo we just created & click __Next__:

![Choosing branch](amplify3.png)

In this view, we can review the default build settings & click __Next__ to continue:

![Build settings](amplify4.png)

Finally, we can review the deployment & click __Save & Deploy__ when we're ready to deploy our app:

![Deploying](amplify5.png)

Once the deployment is successful, you should see this:

![Successful deployment](amplify6.png)

To view details of the deployment, click on the name of the branch (in our case, __master__).
...
![Deployment details](amplify7.png)
