...
Cheap hosting is easy to find - providers like Bluehost and Amazon Lightsail offer WordPress hosting for about $4 a month. Other popular hosts like GoDaddy can get you going for less than $10 a month.
...
Though Ghost is open source, it still requires hosting. The official Ghost recommendation is to use their own Ghost-optimized hosting at about $30 a month, or generic DigitalOcean hosting which can start at less than $10
