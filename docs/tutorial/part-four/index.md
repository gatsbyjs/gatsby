...
Open a new terminal window and and run the following commands to create a new Gatsby site in a directory called tutorial-part-four and then move to this new directory:
