...
If you're building a small site, one efficient way to build it is to pull in unstructured data as outlined in this guide, using the `createPages` API. If the site becomes more complex, you move on to building more complicated sites, or you'd like to transform your data, you may follow these steps:
