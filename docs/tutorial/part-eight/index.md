...
2.  Make sure you have a `description` and an `author` in your `siteMetadata` object, and then also add the `gatsby-plugin-react-helmet` plugin to the `plugins` array in your `gatsby-config.js` file.
