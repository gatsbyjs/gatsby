...
Open a [terminal window] (http://www.macworld.co.uk/feature/mac-software/how-use-terminal-on-mac-3608274/) and type `node --version` then `npm --version`.
...
You'll need code editing software for the next part of this tutorial. [VS Studio] (https://code.visualstudio.com/) is a nice one. After downloading and opening a code editing software, open a folder on your computer called "tutorial-part-one." This folder was automatically created when you ran the previous terminal commands in the first part of this tutorial.
