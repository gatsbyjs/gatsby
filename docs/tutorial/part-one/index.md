...
Note that you will have to press the `enter` key after you see the `domain: some-name.surge.sh` information on your command line interface. Once this finishes running, you should see in your terminal something like:
