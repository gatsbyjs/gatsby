...
4.  Document your plugin with a README, there is a [plugin template](/contributing/how-to-write-a-plugin-readme/#near-perfect-example-of-a-plugin-readme) available to be used as reference.
