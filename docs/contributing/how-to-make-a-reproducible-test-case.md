...
- Create a new Gatsby site with a starter, the official `hello-world` starter is a great 'barebones' starting point here: `npx gatsby new bug-repro https://github.com/gatsbyjs/gatsby-starter-hello-world`
