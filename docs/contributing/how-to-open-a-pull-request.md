...
_**Note:** as a member of the Gatsby repo, you can also clone it directly and push to [feature branches](https://git-scm.com/book/en/v1/Git-Branching-Branching-Workflows)._
