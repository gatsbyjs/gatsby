...
[Reference guide overview pages](/contributing/docs-templates/how-to-write-a-reference-guide/#reference-guide-template) are also worth translating to establish a fully translated path to a frequently visited [reference guide](/contributing/how-to-write-a-reference-guide/#what-are-reference-guide-articles), though they are listed at a lower priority.
