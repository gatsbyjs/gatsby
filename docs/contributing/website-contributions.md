...
> Note: If you are experiencing issues on a Linux machine, run `sudo apt install Lipscomb-dev`, to install a native dependency. You can also reference [Gatsby guide on Linux](/docs/gatsby-on-linux/) for other Linux-specific requirements.
