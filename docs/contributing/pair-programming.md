...
- If you're new to building with Gatsby we recommend [working through the tutorial](https://gatsbyjs.org/tutorial) before your session. If you get stuck part way through that's a great time to book a pairing session.
- If you're new to contributing to open source we recommend following the ["Setting Up Your Local Dev Environment" guide](https://gatsbyjs.org/contributing/setting-up-your-local-dev-environment) before your session.
