...
We on the Gatsby team have run a number of in-person workshops, and you can read about some of our [initial findings](https://gatsbyjs.org/blog/2018-05-31-open-sourcing-gatsby-workshops). If you are interested in running a workshop yourself, we welcome you to do so and offer this page of resources to help you.
