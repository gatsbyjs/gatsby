...
// TODO I think this deserves its own page
...
// TODO image of conflict markers

You may resolve these conflicts however you feel comfortable: through the GitHub UI, from the command line, or with a code editor like VS Code. See the [Common types of updates]() section for how to resolve various conflicts.
...
### Common types of content updates
