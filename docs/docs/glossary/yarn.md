...
- [How to change your default package manager for your next project?](/docs/reference/local-development/gatsby-cli/#how-to-change-your-default-package-manager-for-your-next-project) from the Gatsby CLI docs
