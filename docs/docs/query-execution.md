...
3. The Context, also from the Query Job. Has the page's `path` among other things so that Gatsby can record [Page -> Node Dependencies](/docs/page-node-dependencies/).
