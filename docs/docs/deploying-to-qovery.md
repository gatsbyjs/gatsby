...
That's it! Your site will be live on your autogenerated Qovery URL (which looks like `yoursite-id.qovery.io`) as soon as the build is done. You can choose your own domain by following steps [in the docs](https://docs.qovery.com/services/network/dns#custom-dns-coming-soon-i-want-this-feature).
