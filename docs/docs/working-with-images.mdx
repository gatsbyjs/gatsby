...
<Notification
  ...
  content={
    <div>
      ...
      This document uses the deprecated gatsby-image plugin. Please check out how to work with the new <a href="/docs/how-to/images-and-media/using-gatsby-plugin-image/"><strong>gatsby-plugin-image</strong></a>.
      </p>
    </div>
  }
/>
