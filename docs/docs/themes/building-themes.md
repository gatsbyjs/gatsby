...
> 💡 If you prefer, you can develop themes as [local plugins](https://gatsbyjs.org/docs/creating-a-local-plugin). Using `yarn link` or `npm link` are also viable alternatives. In general, Gatsby recommends the yarn workspaces approach for building themes, and that's what the starter and this guide will reflect.
...
- The [Apollo themes](https://github.com/apollographql/gatsby-theme-apollo/tree/master/packages). (_You might also be interested in the [Apollo case study on themes](https://gatsbyjs.org/blog/2019-07-03-using-themes-for-distributed-docs) on the blog._)
