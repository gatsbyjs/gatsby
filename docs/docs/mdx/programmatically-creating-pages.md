...
[`createFilePath`](https://gatsbyjs.org/packages/gatsby-source-filesystem/?=gatsby-source#createfilepath)
is a function from `gatsby-source-filesystem` that translates file
paths to usable URLs.

[`onCreateNode`](https://gatsbyjs.org/docs/node-apis/#onCreateNode)
...
[createPages](https://gatsbyjs.org/docs/node-apis/#createPages)
API.
