...
To do this, we need to change the structure of the `component` URI in our `createPage` call:

`/absolute/path/to/layout-component.js?__contentFilePath=/absolute/path/to/content.mdx`
