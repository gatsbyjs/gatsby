...
- **pluginOptions**: Plugin options as specified in [gatsby-config.js](/docs/reference/plugins-and-themes/gatsby-config/)
...
API implementations are passed a variety of useful [actions](/docs/reference/builds/actions/) and other interesting functions/objects. These arguments are [created](https://github.com/gatsbyjs/gatsby/blob/8029c6647ab38792bb0a7c135ab4b98ae70a2627/packages/gatsby/src/utils/api-runner-node.js#L94) each time a plugin is run for an API, which allows us to rebind actions with default information.

All actions take 3 arguments:

1. The core information required by the action. E.g. for [createNode](/docs/reference/builds/actions/#createNode), you must pass a node
