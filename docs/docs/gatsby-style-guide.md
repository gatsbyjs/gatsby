...
Article titles should be short and reflect the main theme of the article to help readers quickly find the information they're looking for. Many people use Google to search for things like "gatsby graphql", so the article title should ideally reflect what people might search for on Google.
