...
- [`gatsby-plugin-catch-links`](https://gatsbyjs.org/packages/gatsby-plugin-catch-links) to automatically intercept local links in Markdown files for `gatsby-link` like behavior
