...
- **`gatsby-theme-*`** — this naming convention is used for [Gatsby themes](/docs/themes/), which are a type of plugin. This naming convention is used for plugins that implement multiple plugins or expose files to [shadowing](/docs/themes/shadowing/).
