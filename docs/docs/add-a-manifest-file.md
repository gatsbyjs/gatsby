...
If you've run an [audit with Lighthouse](/docs/audit-with-lighthouse/), you may have noticed a lacklustre score in the "Progressive Web App" category. Let's address how you can improve that score.
