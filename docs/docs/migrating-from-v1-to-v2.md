...
[Gatsby's layout components (`src/layouts/index.js`) are gone now](https://gatsbyjs.org/blog/2018-06-08-life-after-layouts). The "top level component" is now the page itself. If the layout of your site looks broken, this is likely the reason why.
...
[Check the Node interface docs](https://gatsbyjs.org/docs/node-interface) for allowed fields.
