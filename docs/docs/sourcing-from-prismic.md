...
Remember also to add an object of Prismic custom type JSON schemas. You can copy it from JSON editor tab in your custom type page. It's important to keep the name of JSON file **the same** as your custom type's API ID. 
