...
In the GraphiQL IDE at [localhost:8000/__graphql](http://localhost:8000/__graphql) you should now see queryable fields for `allWordpressPosts` in the docs or explorer sidebar.
