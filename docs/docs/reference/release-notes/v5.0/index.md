...
- [Slices API](#todo) - TODO
- [Partial Hydration](#todo) - TODO
- [GraphiQL v2](#todo) - TODO
...
Prefer video over text? No problem! Learn more about all the new features (+ demo) and what we'll work on beyond Gatsby 5 in the video below:
