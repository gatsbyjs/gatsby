...
| `placeholderClassName` | `string`                                                                        |               | CSS class applied to the placeholder element. This will either be an `<img>` (for `blurred` or `tracedSVG` placeholders), or a `<div>` for `dominantColor` or `none`                                                                                           |
...
| `placeholderStyle`     | `CSSProperties`                                                                 |               | Inline styles applied to the placeholder element. This should be used with care, as it is easy to break the layout of the image. The element will either be an `<img>` (for `blurred` or `tracedSVG` placeholders), or a `<div>` for `dominantColor` or `none` |
