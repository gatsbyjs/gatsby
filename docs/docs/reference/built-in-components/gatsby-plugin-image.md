...
| [`width`/`height`](#width-height)       | Source image size                                                             | Change the size of the image. [More info](#width-height)                                        |
...
| [`width`/`height`](#width-height)       | Source image size                                                    | Change the size of the image.                                                                                                                                                                                                                                                                                                                                                                                 |
...
| `sizes`                                 | Generated automatically                                              | The "sizes" property, passed to the img tag. This describes the display size of the image, and does not affect generated images. You are only likely to need to change this if your are using full width images that do not span the full width of the screen.                                                                                                                                                |
