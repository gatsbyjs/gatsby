...
>
> The [schema customization](/docs/schema-customization) and [node materialization](https://github.com/gatsbyjs/gatsby/pull/16091) features have both made changes to this part of Gatsby.
>
