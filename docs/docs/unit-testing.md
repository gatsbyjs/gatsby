...
preference. In this guide, you will use the `__tests__` folder convention. Create a test for your header component, so create a `header.js` file in `src/components/__tests__/`:
