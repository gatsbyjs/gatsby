...
_Note: For this guide, you will be starting with `gatsby-starter-default`, but the concepts should be the same or very similar for your site._
...
If you are using TypeScript, you need to make two changes to your config.
