...
If you want to know more about what GraphQL is and why Gatsby uses it, check out this [conceptual guide](./querying-with-graphql.md) on querying data with GraphQL.
