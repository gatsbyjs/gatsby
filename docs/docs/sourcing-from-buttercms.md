...
Now you've listed your blog posts in `src/pages/blog.js`, using gatsby [createpages](/docs/reference/builds/gatsby-node/#createPages) API you would generate blog post pages using a template:
