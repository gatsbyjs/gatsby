...
Source plugins are reusable integrations with content and data backends. There are already [100s of ready-to-use source plugins for popular content APIs](https://www.gatsbyjs.com/plugins/?=gatsby-source) like Contentful, Drupal, and WordPres. This tutorial teaches you how to build your own integration.
