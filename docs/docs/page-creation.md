...
A page is created by calling the [createPage](/docs/reference/builds/actions/#createPage) action. There are three main side effects that occur when a page is created.
