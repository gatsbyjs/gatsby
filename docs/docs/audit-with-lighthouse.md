...
- [Add a manifest file](/docs/docs/add-a-manifest-file.md/)
- [Add offline support](/docs/docs/add-offline-support-with-a-service-worker.md/)
- [Add page metadata](/docs/docs/add-page-metadata.md/)
