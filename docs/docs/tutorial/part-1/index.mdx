...
You can also generate a Gatsby site without needing to go through all the prompts. In this case, the CLI will use the default values for the prompts except for the site name which you'll need to pass.
