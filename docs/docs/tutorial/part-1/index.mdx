...
For this tutorial, we're using JavaScript, feel free to select the TypeScript option if you're interested in using TypeScript instead. Using TypeScript? checkout our [TypeScript Docs](/how-to/custom-configuration/typescript/)
