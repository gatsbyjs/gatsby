...
Adding such metadata helps search engines like Google to better understand your site. For this tutorial we'll only be adding a title to this page but you can also later add other metadata.
