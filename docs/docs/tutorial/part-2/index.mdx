...
Look back at the [finished example blog site](https://gatsbytutorialexamplev3.gatsbyjs.io/). How might you break down the pages into components?
...
If you take another look at the [finished example blog](https://gatsbytutorialexamplev3.gatsbyjs.io/), you might notice that there are some repeated parts of the UI across each page, like the site title and the navigation menu.
