...
Before you get started, check you the following.

- Have a [Contentful account](https://www.contentful.com/sign-up/)
- Have at least node v14.0 installed
- Have Git installed
- Are using one of the supported remote Git providers

## Create a Repository

Before you get going it's a good idea to create a new repository and at the end of this tutorial you'll deploy your site to Gatsby Cloud by connecting to your chosen Git Provider. You can check the supported Git Providers here: [Gatsby Cloud Supported Git Providers](https://www.gatsbyjs.com/docs/reference/cloud/supported-git-providers/).
...
_In this example I'm using npm, yarn will also work._
...
_For production sites you should add these as environment variables. There's more information in the docs about how to do this: [Environment Variables](https://www.gatsbyjs.com/docs/how-to/local-development/environment-variables/)._
...
With the development server running navigate to the `/__graphql` in your browser.
...
When you're ready click the ▶ button to see the results of the query.
