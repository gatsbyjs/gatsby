...
Now that you've added `gatsby-transformer-sharp` to your site, you'll need to restart your local development server to see the changes in GraphiQL. You'll take a closer look at GraphiQL in the next step.


## Render hero image in the blog post page template

Now that you have all the necessary tools in place, it's time to add your hero image to your blog post page template.
