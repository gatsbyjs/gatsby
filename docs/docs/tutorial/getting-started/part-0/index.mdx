...
- [Node.js](#nodejs) (v18, v20, v22, or v24)
- [Git](#git)
...
[Node.js](https://nodejs.dev/en/learn/) is an environment that can run JavaScript code outside of a web browser. Gatsby is built with Node.js. To get up and running with Gatsby, you’ll need to have Node.js version 18, 20, 22, or 24 installed on your computer.
...
When nvm is installed, it does not default to a particular node version. You’ll need to install the version you want and give nvm instructions to use it. This example uses the version 18 release, but more recent version numbers can be used instead.
