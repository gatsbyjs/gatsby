...
In the previous part of the Tutorial, you started your first Gatsby site and used Netlify to deploy it to the internet. Now that you have everything all set up, it's time to make this site your own!
...
Before you move on, deploy your changes to your live site on Netlify so that you can share your progress!
...
Once your changes have been pushed to GitHub, Netlify should notice the update and rebuild and deploy the latest version of your site. (It may take a few minutes for your changes to be reflected on the live site. Watch your build's progress from your [Netlify dashboard](/dashboard/).)
