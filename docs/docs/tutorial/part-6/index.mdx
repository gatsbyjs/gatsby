...
Now that you've got all the pages for your posts set up, it's time to pull in the actual post contents. To do that, you'll need to give your blog post page template a way to tell Gatsby which MDX node to pull into each page.
