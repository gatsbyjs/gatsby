...
Now that you have some MDX content inside your blog posts, it's time to render them on your Blog page. You'll do that in a few different steps:

1. Install and configure `gatsby-plugin-mdx` and its dependencies.
