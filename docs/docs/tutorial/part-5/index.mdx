...
3. Render your post's previews in your Blog page.
...
### Task: Render your post's previews in your Blog page
...
4. The final step in this part of the Tutorial is to render the preview of your MDX blog posts. In the JSX for your Blog page render the value of the `excerpt` field:
...
5. When you refresh your Blog page in the web browser, you should see your post contents rendered!
