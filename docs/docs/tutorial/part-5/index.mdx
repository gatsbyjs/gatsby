...
**Note:** The excerpt which is returned by the query doesn't contain the MDX formatting so your preview looks a bit weird. But don't worry, you are going to implement a better solution later.
