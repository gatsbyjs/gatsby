...
1. Start by swapping out the `allFile` page query in your Blog page for the one you just created using `allMdx`. (Don't forget to delete the query name!)
...
2. Next, update the JSX for your Blog page to use the data fields off your response. Start by rendering just the title and date for each post.
  ...
  content={
    <div>
      <p>
        ...
        will be added as we finish them. Part 6 has a tentative release date of July 28, 2021.
      </p>
      <p style={{ marginBottom: 0 }}>
        If you{"'"}re looking for a full experience in the meantime, you can check out the (slightly outdated){" "}
        <a href="https://v2.gatsbyjs.com/docs/tutorial/">
