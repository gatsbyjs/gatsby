...
![A screenshot of the home page in a web browser. The title of the page in the browser tab now says, "Home Page", and the top of the page has an unstyled paragraph that says, "My First Gatsby Site".](./index-page-with-site-title.png)
