...
For any kind of pages that aren’t directly created in `src/pages/`, you’ll need Gatsby’s [`createPages` Node API](/docs/reference/builds/gatsby-node/#createPages) to create pages programmatically.
