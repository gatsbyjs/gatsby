...
We recently introduced [Incremental Builds in Gatsby Cloud](https://www.gatsbyjs.org/blog/2020-04-22-announcing-incremental-builds/) to provide support for incremental data changes to Gatsby sites. Incremental Builds only rebuilds the data that has changed, reliably reducing build times to under 10 seconds. 
