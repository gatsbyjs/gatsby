...
The `cache-control` header should be `cache-control: public,max-age=31536000,must-revalidate`
...
To provide a complete working example, this `_headers` file sets up caching correctly for Netlify:
