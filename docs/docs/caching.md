...
When deploying with Now, follow the instructions in the [Now documentation](https://vercel.com/guides/deploying-gatsby-with-vercel#bonus:-cache-your-gatsby-assets).
