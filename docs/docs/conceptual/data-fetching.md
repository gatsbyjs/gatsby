...
- [Gatsby store](https://github.com/gatsbyjs/store.gatsbyjs.com): with static product pages at build time and client-side interactions for e-commerce features
