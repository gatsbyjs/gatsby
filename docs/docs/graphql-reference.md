...
In this query `filter` and the `ne` (not equals) operator is used to show only results that have a title. You can find a good video tutorial on this is [here](https://www.youtube.com/watch?v=Lg1bom99uGM).
