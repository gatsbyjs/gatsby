...
Add the buildpacks. You can do this in `app.json` if you want to take advantage of the [heroku platform API](https://devcenter.heroku.com/articles/setting-up-apps-using-the-heroku-platform-api)
