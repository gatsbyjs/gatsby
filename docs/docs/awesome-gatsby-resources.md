...
- [Carraway](https://github.com/keplersj/carraway): A tool that allows you to configure Gatsby using a JSON object in either gatsby.config.json or package.json (under the "gatsby" key).
