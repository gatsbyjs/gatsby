      ...
      return `
        ...
        ${Object.keys(starters)
          .map(name => {
            ...
            return `
            |[${name}](https://github.com/gatsbyjs/gatsby/tree/master/starters/${name})|[gatsby-starter-${name}-demo.netlify.com](https://gatsby-starter-${name}-demo.netlify.com/)|${starter.description}|
          `.trim()
          })
          .join(`\n`)}
      `.replace(/^[^|]+/gm, ``)
