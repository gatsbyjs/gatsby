...
describe(`fluid`, () => {
  ...
  it(`renders sizes`, () => {
    cy.getTestElement(fluidTestId, `picture > source`).should(
      `have.attr`,
      `sizes`,
  ...
  it(`renders correct srcset`, () => {
    cy.getTestElement(fluidTestId, `picture > source`).should(
      ...
      `srcset`,
      [
        `/static/citrus-fruits-12807bd58d2bc185cad328cf8929ce22-46033.jpg 125w`,
        ...
        `/static/citrus-fruits-12807bd58d2bc185cad328cf8929ce22-33681.jpg 4015w`,
      ].join(`,\n`)
    )
  })
})
