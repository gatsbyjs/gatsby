...
getDirFilesWalk(`public`).then(console.log)

describe(`Webpack Hashes`, () => {
  let basePath
  let rootPath
  // let srcPath
  // let pagesPath
  ...
  test(`are generated correctly on a clean build`, async () => {
    // const public0 = resolve(`${basePath}/public-0`)
    // const public1 = resolve(`${basePath}/public-1`)
    // const files = await getDirFilesWalk(public0)
    // get all files
    // compute hash
  ...
  test.skip(`Add character to src/pages/index.js`, async () => {
    const public0 = resolve(`${basePath}/public-0`)
    const public1 = resolve(`${basePath}/public-1`)
  ...
  test.skip(`Add import to src/pages/index.js`, async () => {
    const public1 = resolve(`${basePath}/public-1`)
  ...
  test.skip(`Add async import to src/pages/index.js`, async () => {
    const public2 = resolve(`${basePath}/public-2`)
  ...
  test.skip(`Add another async import to src/pages/index.js`, async () => {
    const public3 = resolve(`${basePath}/public-3`)
  ...
  test.skip(`Add character to src/async-2.js`, async () => {
    const public4 = resolve(`${basePath}/public-4`)
