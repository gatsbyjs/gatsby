...
3.  **Open the code and start customizing!**
    ...
    To get started, check out the guide to [getting started with themes](http://gatsbyjs.org/docs/themes/using-a-gatsby-theme), or the longer, [more detailed tutorial](http://gatsbyjs.org/tutorial/using-a-theme).
