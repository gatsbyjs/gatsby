...
3.  **Open the code and start customizing!**
    ...
    To get started, check out the guide to [getting started with using the blog theme starter](http://gatsbyjs.org/docs/themes/using-a-gatsby-theme), or the longer, [more detailed tutorial](http://gatsbyjs.org/tutorial/using-a-theme).

## 🧐 What's inside?

A quick look at the top-level files and directories you'll see in a site created using the blog theme starter.
...
4.  **`.prettierrc`**: This file tells git which files it should not track / not maintain a version history for.
